...
namespace pgso
{
    ...
    public partial class frm_Equipment_Cancelled : Form
    {
        //fields
        ...
        public frm_Equipment_Cancelled()
        {
            InitializeComponent();
        ...
        //methods 
        private void frm_Equipment_Cancelled_Load(object sender, EventArgs e)
        {
            RefreshData();
        ...
        private void RefreshData()
        {
            try
            {
                ...
                LoadData(queryPending, dt_cancelled, "Pending");
