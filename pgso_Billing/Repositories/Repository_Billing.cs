...
namespace pgso.Billing.Repositories
{
    internal class Repo_Billing
    {
        ...
        {
            // You can modify the SQL query to filter by reservationID to get a specific record
            ...
            try
            {
                ...
                {
                    conn.Open();
                    Console.WriteLine("✅ Fetching Billing Details for Reservation ID: " + reservationID);
