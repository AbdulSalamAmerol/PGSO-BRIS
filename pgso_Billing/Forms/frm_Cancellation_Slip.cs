...
{
    public partial class frm_Cancellation_Slip : Form
    {
        ...
        public frm_Cancellation_Slip(int reservationId)
        {
            InitializeComponent();
            _reservationId = reservationId;

            // 2) Hook the Load event
            this.Load += frm_Cancellation_Slip_Load;
        }

        private void frm_Cancellation_Slip_Load(object sender, EventArgs e)
        {
        ...
        private void DisplayReport()
        {
            ...
            Cancellation_Slip_Report_Viewer.LocalReport.ReportEmbeddedResource
                = "pgso.pgso_Billing.Forms.Report_Cancellation_Slip.rdlc";
            ...
            Cancellation_Slip_Report_Viewer.LocalReport.DataSources.Clear();
            Cancellation_Slip_Report_Viewer.LocalReport.DataSources.Add(rds);

            Cancellation_Slip_Report_Viewer.RefreshReport();
        }
    }
}
